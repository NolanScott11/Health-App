...
Open the folder in Visual Studio as an existing project, or create a new Console App project and add all .h and .cpp files
Set the C++ standard to C++17 — in project properties: Configuration Properties → General → C++ Language Standard → ISO C++17
