...
## Planned Features
- [ ] Live food search via nutrition API (Open Food Facts / USDA)
- [ ] CSV food database import
- [ ] AI-powered lift progression predictions
- [ ] Meal templates / saved meal groups
- [ ] Weekly nutrition and workout summary reports
- [ ] Cross-platform support (remove Windows-only dependencies)

---

## Known Limitations
- Windows only (`system("CLS")`, `ctime_s`)
- All values stored as integers — no decimal weights or fractional macros
- No user accounts — single user per installation
